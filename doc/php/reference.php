...
<li><a id="menulinkactive" href="/cgi-bin/reference.php?channel=<?php echo $channel;?>">Reference Measurement</a></li>
...
<?php
if ($posted) {
	echo '<iframe style=\'float:right; margin-left:20px\' frameBorder=0 src=\'/cgi-bin/scope.php?refresh=' . $_POST['scopeinterval'] .  '&channel=' . $channel . '&mode=immediate\' width=800 height=600></iframe>';
}
?>
<br>
<table>
<tr>
<td align=right>Save reference spectrum to</td>
